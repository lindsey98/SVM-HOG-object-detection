...
if __name__ == "__main__":
    ...
    parser.add_argument('-data', "--data_folder", help='Training brands\' screenshots to create positive samples', default= 'D:/ruofan/git_space/phishpedia/benchmark/Train_5brand')
    parser.add_argument('-annot', "--annot_file", help='Annotation for training brands', default='D:/ruofan/git_space/phishpedia/benchmark/phish1000_coord.txt' )
